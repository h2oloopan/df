 ...
 *@date Jan 14, 2015
 */
public class UnderMatcher extends PatternMatcher
{
    ...
    {
        return MatchHelper.wildMatch(path, node, inputThatTopic, starState, starIndex, inputStars, grammarStars, thatStars, topicStars, "_", matchTrace);
    }
