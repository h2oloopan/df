...
public class IntervalHandler extends TagHandler
{
    ...
    {
        String style = HandlingHelper.getAttributeOrTagValue(node, ps, "style");      // AIML 2.0
        String jformat = HandlingHelper.getAttributeOrTagValue(node, ps, "jformat");      // AIML 2.0
        String from = HandlingHelper.getAttributeOrTagValue(node, ps, "from");
        String to = HandlingHelper.getAttributeOrTagValue(node, ps, "to");
