    ...
    public static String recursEval(Node node, ParseState ps) throws Exception {
        ...
        if (nodeName.equals("#text")) return node.getNodeValue();
            ...
            return srai(node, ps);
              ...
              return respond(ps.bot, ps.context, ps.profile, ps.starBindings.inputStars.star(0), ps.that, ps.topic);
    ...
    */
    ...
    private static String srai(Node node, ParseState ps) {
        ...
        try {
            ...
            response = evalTemplate(leaf.category.getTemplate(), new ParseState(ps.depth + 1, ps.input, ps.that, ps.topic, leaf, ps.bot, ps.context, ps.profile));
