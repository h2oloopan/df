...
public class PreProcessor
{
     ...
     * @param bot       AIML bot
     */
    public PreProcessor (Brain brain) {

        normalCount = readSubstitutions(brain.config_path+"/normal.txt", normalPatterns, normalSubs);
        denormalCount = readSubstitutions(brain.config_path+"/denormal.txt", denormalPatterns, denormalSubs);
        personCount = readSubstitutions(brain.config_path +"/person.txt", personPatterns, personSubs);
        person2Count = readSubstitutions(brain.config_path +"/person2.txt", person2Patterns, person2Subs);
        genderCount = readSubstitutions(brain.config_path +"/gender.txt", genderPatterns, genderSubs);
