...
public class RequestTagTest
{
    ...
    public void nothing() {
        try {
            System.out.println("Testing request tag with nothing in history");
            ...
            Category c2 = new Category(0, "你说了什么", "*", "*", "*", "没什么<request index=\"2\"/>", "dummy.aiml");
    ...
    public void something() {
        try {
            System.out.println("Testing request tag with something in history");
            ...
            Category c2 = new Category(0, "你说了什么", "*", "*", "*", "没什么<request index=\"1\"/>", "dummy.aiml");
            bot.brain.addCategory(c2);
            ...
            Assert.assertEquals("没什么你好", result);
        } catch (Exception e) {
            e.printStackTrace();
            Assert.fail("Should not get exception here, but " + e.getMessage());
        }
