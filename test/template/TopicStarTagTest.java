...
public class TopicStarTagTest
{
    ...
    public void noStar() {
        try {
            System.out.println("Testing topic star with no star");
    ...
    public void oneStar() {
        try {
            System.out.println("Testing topic star with one star");
    ...
    public void twoStars() {
        try {
            System.out.println("Testing topic star with two stars");
